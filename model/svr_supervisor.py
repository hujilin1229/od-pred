...
class SVRSupervisor(FCRNNSupervisor):
    """
    ...
    def __init__(self, traffic_reading_df, adj_mx, config,
        ...
        super(SVRSupervisor, self).__init__(traffic_reading_df, adj_mx, config,
                 origin_df_file, nodes)
    ...
    def _generate_run_id(config):
        ...
        if filter_type == 'random_walk':
            ...
            filter_type_abbr = 'DR'
        run_id = 'svr_{}_h_{}_{}_lr_{}_bs_{}_d_{}_sl_{}_{}_{}_{}_{}_{}/'.format(
