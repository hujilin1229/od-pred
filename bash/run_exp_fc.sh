...
# srun -n 1 --exclusive python fcgrnn_train.py --test_every_n_epochs 10 --sample_rate 15 --data_format 'speed' --seq_len 3 --horizon 3 --num_gpus 2 --fill_mean=False --sparse_removal=False --learning_rate 0.001 --lr_decay 0.8 --lr_decay_epoch 5 --batch_size 8 --loss_func 'L2' --activate_func 'tanh' --pool_type '_mpool' --drop_out 0.0 --use_curriculum_learning=True --sigma 9 --hopk 2 --optimizer 'adam' --fc_method='direct'&
# srun -n 1 --exclusive python fcgrnn_train.py --test_every_n_epochs 10 --sample_rate 15 --data_format 'speed' --seq_len 6 --horizon 3 --num_gpus 2 --fill_mean=False --sparse_removal=False --learning_rate 0.001 --lr_decay 0.8 --lr_decay_epoch 5 --batch_size 8 --loss_func 'L2Norm' --drop_out 0.2 --use_curriculum_learning=True --sigma 9 --hopk 2 --optimizer 'adam' --fc_method='od' --trace_ratio 0.01 &
# srun -n 1 --exclusive python fcgrnn_train.py --test_every_n_epochs 10 --sample_rate 15 --data_format 'speed' --seq_len 6 --horizon 3 --num_gpus 2 --fill_mean=False --sparse_removal=False --learning_rate 0.001 --lr_decay 0.8 --lr_decay_epoch 5 --batch_size 8 --loss_func 'L2Norm' --drop_out 0.2 --use_curriculum_learning=True --sigma 9 --hopk 2 --optimizer 'adam' --fc_method='od' --trace_ratio 0.001 &
# srun -n 1 --exclusive python fcgrnn_train.py --test_every_n_epochs 10 --sample_rate 15 --data_format 'speed' --seq_len 6 --horizon 3 --num_gpus 2 --fill_mean=False --sparse_removal=False --learning_rate 0.001 --lr_decay 0.8 --lr_decay_epoch 5 --batch_size 8 --loss_func 'L2Norm' --drop_out 0.2 --use_curriculum_learning=True --sigma 9 --hopk 2 --optimizer 'adam' --fc_method='od' --trace_ratio 0.0001 &
# srun -n 1 --exclusive python fcgrnn_train.py --test_every_n_epochs 10 --sample_rate 15 --data_format 'speed' --seq_len 3 --horizon 3 --num_gpus 2 --fill_mean=False --sparse_removal=False --learning_rate 0.001 --lr_decay 0.8 --lr_decay_epoch 5 --batch_size 8 --loss_func 'L2Norm' --drop_out 0.2 --use_curriculum_learning=True --sigma 9 --hopk 2 --optimizer 'adam' --fc_method='direct' &
