...
flags.DEFINE_integer('sigma', 8, 'sigma used to construct the adj matrix')
...
def main(_):
    ...
    with open(FLAGS.config_filename) as f:
        ...
        for name in ['batch_size', 'cl_decay_steps', 'epochs', 'horizon', 'learning_rate', 'l1_decay',
                     ...
                     'zone', 'scaler', 'data_format', 'num_gpus', 'mode', 'shuffle_training', 'optimizer',
                     'fc_method', 'drop_out', 'trace_ratio', 'hopk']:
